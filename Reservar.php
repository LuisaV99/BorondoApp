...
<div class="block1">
  ...
  <div class="titulo"><h3 class="nombre"><?php echo $row['Nombre'] ?></h3></div>
  <div><p class="descrip1"><?php echo $row['Descripcion1'] ?></p></div>
  <div class="slider">
              <div class="slide">
            ...
            <div><p class="descrip1"><?php echo $row['Descripcion2'] ?></p></div>
            <div>
