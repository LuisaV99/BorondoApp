...
function Header()
{
    ...
    $this->Cell(30,10,'Reservas del mes actual',);
    // Salto de línea
    $this->Ln(20);
...
$Consulta = "SELECT * FROM reservas INNER JOIN usuarios ON reservas.Documento=usuarios.Documento WHERE DATE_FORMAT(reservas.FechaRgR, '%Y%m') = DATE_FORMAT(CURDATE(),'%Y%m');";
