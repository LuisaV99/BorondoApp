...
function Header()
{
    ...
    $this->SetLineWidth(.3);
    $this->SetTitle('UsuariosConMasReservas');
    $this->SetTextColor(65,88,208);
    $this->Cell(30,10,'Registros Con Mas Reservas',);
    // Salto de línea
    $this->Ln(20);
...
$Consulta = "SELECT usuarios.Documento, usuarios.Nombres, usuarios.Apellidos, usuarios.Correo, COUNT(reservas.Documento) as NReservas FROM reservas INNER JOIN usuarios on usuarios.Documento=reservas.Documento GROUP BY reservas.Documento ORDER BY NReservas DESC LIMIT 100;";
