...
<?php
         ...
         <img class="logo-boro" src="./images/Logo.png" alt="Oculto ajjajajja no sabia que esto se podia" />
          ...
          <p class="">Aqui tienes los detalles de tu reserva</p>
...
<h1>Detalles</h1>
<p>Codigo de reserva: <?php echo $row['ID_Reserva'] ?></p>
<h5>Contenido</h5>
...
<h3>Como pagar</h3>
<p>Numero de cuenta: <strong> <?php echo $row['N_Cuenta'] ?> </strong> </p>
<img  src="https://i0.wp.com/bixxus.com/wp-content/uploads/2022/06/nequi-logo-1.png?resize=1920%2C1842&ssl=1" 
alt="Oculto ajjajajja no sabia que esto se podia" width="45px"/>

<hr width="100%">

<p>No sé pagar, <a href="./ComoPagarBorondoApp.pdf" Target="_blank" style="    text-decoration: revert;">Aprende aquí</a></p>
